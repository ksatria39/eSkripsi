              ...
              <table class="table">
                ...
                <?php $no = 1; foreach($mahasiswa as $mahasiswa) { ?>
                  <tr>
                    ...
                    <td>
                        <a type="submit" class="btn btn-primary" href="<?= base_url() ?>score_proposal/dosen2">Sunting</a>
                        <a type="submit" class="btn btn-danger" href="<?= base_url() ?>score_proposal/dosen2">Hapus</a>
                    </td>
                  </tr>
                <?php } ?>
                </tbody>
