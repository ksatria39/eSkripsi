            ...
            <?php foreach ($data_proposal as $row) : ?>
              <tr>
                ...
                <td>
                  ...
                  ?>
                  <span class="badge badge-status <?php echo $badge_class; ?>"><?php echo ucfirst($row->status); ?></span>
                </td>
                <td>
                  <a href="<?= site_url('Progress_proposal/delete_progress/' . $row->id) ?>" class="btn btn-danger btn-custom" onclick="return confirm('Are you sure you want to delete this progress proposal?')">
