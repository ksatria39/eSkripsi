  ...
  <div class="card-body">
    ...
    <body>
      <div class="container">
        ...
        <form method="post" action="<?php echo base_url('progress_proposal/insert_bimbingan'); ?>" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <select class="form-control" id="judul" name="judul">
              <?php foreach ($judul_list as $judul) : ?>
                <option value="<?php echo $judul->id; ?>"><?php echo $judul->judul; ?></option>
              <?php endforeach; ?>
            </select>
          </div>
