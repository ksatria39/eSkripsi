						...
						<table class="table">
							...
							<tbody>
								...
								foreach ($all as $all) { ?>
									...
									<div class="modal fade" id="myModal<?= $all->skp_id; ?>" tabindex="-1">
										<div class="modal-dialog">
											<div class="modal-content">
												...
												<div class="modal-body">
													<form class="row g-3 needs-validation border-top" action="<?php echo base_url('schedule_skripsi/update'); ?>" method="post" novalidate>

														<input type="hidden" id="id" name="id" value="<?= $all->skp_id; ?>"></input>
